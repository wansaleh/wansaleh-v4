          ...
          >
            ...
            <ol className="mt-8 space-y-6">
              <li className="space-y-2">
                <h2 className="md:text-xl text-lg">UnstyledLink</h2>
              ...
              <li className="space-y-2">
                <h2 className="md:text-xl text-lg">CustomLink</h2>
                <p className={clsx('text-sm !mt-1', textColor)}>
              ...
              <li className="space-y-2">
                <h2 className="md:text-xl text-lg">ButtonLink</h2>
                <p className={clsx('text-sm !mt-1', textColor)}>
              ...
              <li className="space-y-2">
                <h2 className="md:text-xl text-lg">Button</h2>
                <p className={clsx('text-sm !mt-1', textColor)}>
              ...
              <li className="space-y-2">
                <h2 className="md:text-xl text-lg">Next Image</h2>
                <p className={clsx('text-sm !mt-1', textColor)}>
