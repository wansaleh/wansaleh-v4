...
export default function SongCard({ song }: { song: Song }) {
  return (
    <div className="bg-gray-500/10 duration-300 group group h-full link-overlay relative ring-1 ring-gray-500/10 rounded-xl shadow-lg transition w-full dark:hover:ring-offset-gray-900 hover:ring-gray-500/20 hover:shadow-xl">
      ...
      <div className="p-4">
        <h2 className="font-bold leading-tight text-xl">
          <a
        ...
        <div className="font-semibold leading-tight line-clamp-1 mt-0.5 text-base text-gray-500">
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="-bottom-6 absolute font-medium leading-tight mt-2 text-gray-500 text-xs dark:text-gray-500">
            id: {song.id}
          </div>
        )}
      </div>
    ...
    <div className="flex font-medium gap-1.5 items-center links relative text-sm transform transition z-50">
      ...
      <a href={song.permalink} target="_blank" rel="noopener noreferrer">
        ...
        <svg
          ...
          className="-mt-1 h-[1.15em] inline-block ml-0.5"
          fill="currentColor"
          xmlSpace="preserve"
        >
